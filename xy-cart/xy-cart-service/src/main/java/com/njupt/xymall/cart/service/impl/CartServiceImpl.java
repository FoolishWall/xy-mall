...
public class CartServiceImpl implements CartService {
	...
	@Override
	public XYResult addCart(long userId, long itemId, int num) {
		// 向redis中添加购物车。
	...
	@Override
	public XYResult mergeCart(long userId, List<TbItem> itemList) {
		//遍历商品列表
		//把列表添加到购物车。
		//判断购物车中是否有此商品
		//如果有，数量相加
	...
	@Override
	public XYResult updateCartNum(long userId, long itemId, int num) {
		//从redis中取商品信息
		String json = jedisClient.hget(REDIS_CART_PRE + ":" + userId, itemId + "");
		//更新商品数量
	...
	@Override
	public XYResult deleteCartItem(long userId, long itemId) {
		// 删除购物车商品
	...
	@Override
	public XYResult clearCartItem(long userId) {
		//删除购物车信息
